...
(after! org
  ...
  (custom-set-faces!
    '(org-document-title :inherit fixed-pitch :weight bold :height 1.55)
    '(org-level-1 :inherit fixed-pitch :weight bold :height 1.42)
    '(org-level-2 :inherit fixed-pitch :weight bold :height 1.24)
    '(org-level-3 :inherit fixed-pitch :weight semi-bold :height 1.14)
    '(org-level-4 :inherit fixed-pitch :weight semi-bold :height 1.08)
    '(org-level-5 :inherit fixed-pitch :weight normal :height 1.03)
    '(org-level-6 :inherit fixed-pitch :weight normal :height 1.0)
    '(org-level-7 :inherit fixed-pitch :weight normal :height 1.0)
    '(org-level-8 :inherit fixed-pitch :weight normal :height 1.0)
