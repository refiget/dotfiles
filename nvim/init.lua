...
keymap("n", "<localleader>le", function()
	vim.diagnostic.open_float(0, { scope = "line", focus = true, border = "rounded", max_width = 120 })
end, { silent = true, desc = "LSP line error (expanded)" })
